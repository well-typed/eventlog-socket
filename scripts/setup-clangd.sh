...
echo "    - '-DEVENTLOG_SOCKET_FEATURE_CONTROL=1'" >>"${CLANGD_FILE}"
echo "    - '-xc'" >>"${CLANGD_FILE}"
...
echo "Diagnostics:" >>"${CLANGD_FILE}"
echo "  ClangTidy:" >>"${CLANGD_FILE}"
echo "    Add:" >>"${CLANGD_FILE}"
echo "      - 'bugprone-*'" >>"${CLANGD_FILE}"
echo "      - 'clang-analyzer-*'" >>"${CLANGD_FILE}"
echo "      - 'concurrency-*'" >>"${CLANGD_FILE}"
echo "      - 'misc-*'" >>"${CLANGD_FILE}"
echo "      - 'performance-*'" >>"${CLANGD_FILE}"
echo "      - 'portability-*'" >>"${CLANGD_FILE}"
echo "      - 'readability-*'" >>"${CLANGD_FILE}"
echo "    Remove:" >>"${CLANGD_FILE}"
echo "      - 'bugprone-branch-clone'" >>"${CLANGD_FILE}"
echo "      - 'readability-else-after-return'" >>"${CLANGD_FILE}"
echo "      - 'readability-function-cognitive-complexity'" >>"${CLANGD_FILE}"
echo "      - 'readability-identifier-length'" >>"${CLANGD_FILE}"
echo "  UnusedIncludes: 'Strict'" >>"${CLANGD_FILE}"
