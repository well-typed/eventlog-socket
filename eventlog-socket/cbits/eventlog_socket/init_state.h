...
#define EVENTLOG_SOCKET_SIG_INITIALIZED 1 // 0b00000001

/// @brief Bit flag for `g_init_state` that tracks whether or not the function
/// @c SocketEventLogWriter->initEventLogWriter has been called.
#define EVENTLOG_SOCKET_SIG_ATTACHED 2 // 0b00000010

/// @brief Bit flag for `g_init_state` that tracks whether or not the function
/// @c eventlog_socket_signal_ghc_rts_ready has been called.
#define EVENTLOG_SOCKET_SIG_RTS_READY 4 // 0b00000100
...
#define EVENTLOG_SOCKET_SIG_HAD_FIRST_CONNECTION 8 // 0b00001000
